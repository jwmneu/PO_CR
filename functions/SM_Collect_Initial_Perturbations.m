function [p_mat_rigid_initialization_n, p_mat_nonrigid_initialization_n, Perturbed_SIFT_Feature_labels_n] = SM_Collect_Initial_Perturbations(n1, n2, SIFT_scale, Kpi)
	...
	p_mat_nonrigid_initialization = p_mat_nonrigid_initialization.p_mat_nonrigid_initialization_5_lms;
	p_mat_nonrigid_gtperturbed = p_mat_nonrigid_gtperturbed.p_mat_nonrigid_gtperturbed_5_lms;
	p_mat_rigid_gtperturbed = p_mat_rigid_gtperturbed.p_mat_rigid_gtperturbed_5_lms;
	...
	if SAVE == 1
		...
		save([saveDir 'p_mat_rigid_initialization_5_lms_' num2str(n1) '-' num2str(n2) '_Kpi-' num2str(Kpi) '.mat'], 'p_mat_rigid_initialization_n');
		save([saveDir 'p_mat_nonrigid_initialization_5_lms_' num2str(n1) '-' num2str(n2)  '_Kpi-' num2str(Kpi) '.mat'], 'p_mat_nonrigid_initialization_n');
		save([saveDir 'p_mat_nonrigid_gtperturbed_5_lms_' num2str(n1) '-' num2str(n2) '_Kpi-' num2str(Kpi) '.mat'], 'p_mat_nonrigid_gtperturbed_n');
		save([saveDir 'p_mat_rigid_gtperturbed_5_lms_' num2str(n1) '-' num2str(n2) '_Kpi-' num2str(Kpi) '.mat'], 'p_mat_rigid_gtperturbed_n');
	end
end